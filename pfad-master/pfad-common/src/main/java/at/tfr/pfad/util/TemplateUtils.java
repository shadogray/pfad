...
public class TemplateUtils implements Serializable {
	...
	public String replace(String template, List<Entry<String,Object>> map, String defaultValue) {
	...
	public String replace(String template, List<Entry<String,Object>> map) {
	...
	public class BeansStrLookup extends StrLookup<String> {
		...
		public BeansStrLookup(List<Entry<String,Object>> map) {
			this.map = map;
		}
