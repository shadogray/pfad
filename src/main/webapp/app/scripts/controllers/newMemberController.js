...
angular.module('pfad').controller('NewMemberController', function ($scope, $location, locationParser, flash, MemberResource , SquadResource, MemberResource, FunctionResource, MemberResource, PaymentResource, BookingResource) {
