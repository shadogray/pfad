...
angular.module('pfad').controller('EditSquadController', function($scope, $routeParams, $location, flash, SquadResource , MemberResource, MemberResource, MemberResource, MemberResource) {
    var self = this;
    ...
    $scope.get = function() {
        ...
        var errorCallback = function() {
            flash.setMessage({'type': 'error', 'text': 'The squad could not be found.'});
            $location.path("/Squads");
        };
        SquadResource.get({SquadId:$routeParams.SquadId}, successCallback, errorCallback);
    };
    ...
    $scope.save = function() {
        var successCallback = function(){
            flash.setMessage({'type':'success','text':'The squad was updated successfully.'}, true);
            $scope.get();
        };
    ...
    $scope.remove = function() {
        var successCallback = function() {
            flash.setMessage({'type': 'error', 'text': 'The squad was deleted.'});
            $location.path("/Squads");
        };
        var errorCallback = function(response) {
            if(response && response.data && response.data.message) {
