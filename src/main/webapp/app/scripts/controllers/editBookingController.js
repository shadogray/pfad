...
angular.module('pfad').controller('EditBookingController', function($scope, $routeParams, $location, flash, BookingResource , PaymentResource, MemberResource, ActivityResource, SquadResource) {
    var self = this;
