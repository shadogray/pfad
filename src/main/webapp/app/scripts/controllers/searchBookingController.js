...
angular.module('pfad').controller('SearchBookingController', function($scope, $http, $filter, BookingResource , PaymentResource, MemberResource, ActivityResource, SquadResource) {
