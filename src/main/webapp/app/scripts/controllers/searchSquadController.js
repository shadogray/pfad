...
angular.module('pfad').controller('SearchSquadController', function($scope, $http, $filter, SquadResource , MemberResource, MemberResource, MemberResource, MemberResource) {
